...
I'm a full stack developer based in Bengaluru, focused on building clean web applications with sharp UX and practical AI integrations. I enjoy writing type-safe code, breaking down complex UI problems, and thinking hard about architecture. Currently building with the React/Next.js ecosystem, integrating LLMs into real workflows, and solving DSA problems to keep the fundamentals sharp.
